...
if __name__ == "__main__":
  ...
  try:
    ...
    loggin.warning("Unable to connect to the database")
  ...
  while(True):
    ...
    if db_conn:
      db_conn.cursor().execute("INSERT INTO measurements( \
	                          \"timestamp\", production_w, consumption_w, grid_feed_in_w, grid_retrieve_w, battery_level, \
                            ...
                            (psycopg2.TimestampFromTicks(data.get_timestamp()),
